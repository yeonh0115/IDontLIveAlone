...
from pi_runtime import LatestFrame, Settings, event_log_id, upload_fields
...
def upload_to_cloud_websocket():
    while True:
        ...
        try:
            ...
            connection = websocket.create_connection(RENDER_WS_URL, timeout=5, sslopt=ssl_options)
            last_sequence = -1
...
def trigger_event():
    ...
    if success:
        return jsonify(status="success", image_url=image_url, log_id=log_id), 200
